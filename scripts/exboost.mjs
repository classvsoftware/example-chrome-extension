...
const i = new (class {
    ...
    renderSlotDataOrError(
        ...
        return n(this, void 0, void 0, function* () {
            ...
            t.innerHTML = `<div class="exboost-container ${null != o ? o : ""
                }">\n      ${n.anchorData
                    .map(
                        (e) =>
                            `<a class="exboost-link ${null != s ? s : ""}" href="${e.href
